    ...
    <div>
      ...
      <section className="relative h-[55vh] min-h-[380px]">
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-end pb-16 px-6 sm:px-12 lg:px-20">
          ...
          <p className="text-[11px] tracking-[0.3em] uppercase text-white/60 mb-2" style={{ fontFamily: "Inter, sans-serif" }}>Home Features</p>
      ...
      <section className="pb-10 px-6 sm:px-12 lg:px-20 max-w-7xl mx-auto">
        <div className="bg-black text-white p-8 lg:p-12">
          <p className="text-[10px] tracking-[0.3em] uppercase text-gray-500 mb-3" style={{ fontFamily: "Inter, sans-serif" }}>Included</p>
          <h2 className="text-2xl text-white mb-6" style={{ fontFamily: "Playfair Display, serif", fontWeight: 500 }}>Move-In Ready Upgrades</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-2">
            {[
              ...
              <div key={item} className="flex items-start gap-2.5 py-1.5 border-b border-gray-800">
                ...
                <span className="text-sm text-gray-300" style={{ fontFamily: "Inter, sans-serif" }}>{item}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-10 px-6 sm:px-12 lg:px-20 max-w-7xl mx-auto">
        <div className="mb-8">
          <p className="text-[10px] tracking-[0.3em] uppercase text-gray-400 mb-2" style={{ fontFamily: "Inter, sans-serif" }}>All Features</p>
          <h2 className="text-3xl text-black" style={{ fontFamily: "Playfair Display, serif", fontWeight: 500 }}>Explore Every Room</h2>
        </div>
        <div className="grid lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-2 space-y-1">
            {features.map((f, i) => (
              ...
              >
                <span
                  className={`text-2xl shrink-0 ${active === i ? "text-white/40" : "text-gray-200"}`}
                  style={{ fontFamily: "Playfair Display, serif" }}
                >
                  {f.num}
                </span>
                <div>
                  <p className="text-[12px] tracking-wide" style={{ fontFamily: "Inter, sans-serif", fontWeight: active === i ? 600 : 500 }}>{f.title}</p>
                  <p className={`text-[11px] ${active === i ? "text-gray-400" : "text-gray-400"}`} style={{ fontFamily: "Inter, sans-serif" }}>{f.sub}</p>
                </div>
              </button>
            ))}
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex items-start gap-4 mb-4">
              <span className="text-4xl text-gray-100" style={{ fontFamily: "Playfair Display, serif" }}>{current.num}</span>
              <div>
                <p className="text-[11px] tracking-[0.2em] uppercase text-gray-400 mb-1" style={{ fontFamily: "Inter, sans-serif" }}>{current.sub}</p>
                <h3 className="text-2xl text-black" style={{ fontFamily: "Playfair Display, serif", fontWeight: 500 }}>{current.title}</h3>
              </div>
            </div>
            <p className="text-gray-600 leading-relaxed mb-5" style={{ fontFamily: "Inter, sans-serif" }}>{current.body}</p>
      ...
      <section className="py-16 px-6 text-center bg-gray-50">
        <div className="max-w-xl mx-auto">
          <p className="text-[10px] tracking-[0.3em] uppercase text-gray-400 mb-3" style={{ fontFamily: "Inter, sans-serif" }}>Love what you see?</p>
