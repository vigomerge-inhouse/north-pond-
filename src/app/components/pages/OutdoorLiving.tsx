...
const outdoorAmenities = [
  ...
  { name: "Landlord yard maintenance", sub: "Professional lawn care provided year-round" },
  ...
  { name: "Walking trails possible", sub: "Create private nature trails through your wooded acres" },
];
    ...
    <div>
      ...
      <section className="relative h-[65vh] min-h-[480px]">
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-end pb-16 px-6 sm:px-12 lg:px-20">
          ...
          <p className="text-3xl text-white/80 italic mb-6" style={{ fontFamily: "Cormorant Garamond, serif" }}>
            Outdoor Living
          </p>
          <p className="text-xl text-white/70 italic" style={{ fontFamily: "Cormorant Garamond, serif" }}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed" style={{ fontFamily: "Inter, sans-serif" }}>
              The landlord maintains the yard, provides professional winter snowplowing, and will install a dog-friendly perimeter fence. The property's generous acreage offers countless possibilities — create flower gardens, walking trails, gathering spaces, or natural meadows.
            </p>
          </div>
          <div className="relative">
            ...
            <blockquote className="mt-6 border-l-2 border-black pl-5">
              <p className="text-gray-600 italic" style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "1.15rem" }}>
                "Create gardens, trails, or meadows that enhance the natural beauty. Mature trees and open space invite wildlife and seasonal color — the landlord supports your vision to keep this outdoor oasis flourishing year-round."
              </p>
            </blockquote>
          </div>
        </div>
      ...
      <section className="py-16 px-6 sm:px-12 lg:px-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <p className="text-[10px] tracking-[0.3em] uppercase text-gray-400 mb-3" style={{ fontFamily: "Inter, sans-serif" }}>Included</p>
          <h2 className="text-3xl text-black mb-8" style={{ fontFamily: "Playfair Display, serif", fontWeight: 500 }}>Outdoor Amenities</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-4">
            {outdoorAmenities.map((item) => (
              <div key={item.name} className="flex items-start gap-3 py-3 border-b border-gray-200">
                ...
                <div>
                  <p className="text-sm text-black" style={{ fontFamily: "Inter, sans-serif", fontWeight: 600 }}>{item.name}</p>
      ...
      <section className="py-20 px-6 sm:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[10px] tracking-[0.3em] uppercase text-gray-400 mb-3" style={{ fontFamily: "Inter, sans-serif" }}>Four Seasons of Beauty</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {seasons.map((season) => (
              <div key={season.name} className={`${season.color} p-0 overflow-hidden`}>
                ...
                <div className="p-5">
                  <h3 className="text-lg text-black mb-2" style={{ fontFamily: "Playfair Display, serif", fontWeight: 600 }}>{season.name}</h3>
      ...
      <section className="py-16 px-6 sm:px-12 lg:px-20 bg-black text-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-[10px] tracking-[0.3em] uppercase text-gray-500 mb-3" style={{ fontFamily: "Inter, sans-serif" }}>Dog Friendly Property</p>
            <h2 className="text-3xl mb-5" style={{ fontFamily: "Playfair Display, serif", fontWeight: 500 }}>
              A genuinely dog-friendly property.
            </h2>
            <p className="text-gray-400 leading-relaxed mb-6" style={{ fontFamily: "Inter, sans-serif" }}>
              The landlord plans to install a perimeter fence to create a safe, secure space for your dog. With 2 private wooded acres, your dog will have space to roam, explore, and thrive in a true Maine country setting. If you have a dog, this is the property for you.
            </p>
            <Link
              to="/schedule-showing"
          ...
          <div className="aspect-[4/3] overflow-hidden">
            <ImageWithFallback
              src={imgForest}
              alt="Private wooded acres — dog friendly"
      ...
      <section className="py-20 px-6 sm:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <p className="text-[10px] tracking-[0.3em] uppercase text-gray-400 mb-1" style={{ fontFamily: "Inter, sans-serif" }}>Outdoor Gallery</p>
      ...
      <section className="py-16 px-6 bg-gray-50 text-center">
        <div className="max-w-xl mx-auto">
          <p className="text-gray-700 mb-2" style={{ fontFamily: "Inter, sans-serif" }}>Experience it yourself</p>
