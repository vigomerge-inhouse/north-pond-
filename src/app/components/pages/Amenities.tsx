...
const amenityGroups = [
  {
    ...
    items: [
      ...
      { name: "Modern faucet & hardware", sub: "Designer selections throughout" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Spacious entertainment deck", sub: "Large, private outdoor entertaining space" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Nature surroundings", sub: "Trails, woods, and wildlife to discover" },
...
const showcaseImages = [imgKitchen, imgH5, imgHg1, imgHome].map((src, i) => ({
  src,
    ...
    <div>
      ...
      <section className="relative h-[55vh] min-h-[380px]">
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-end pb-16 px-6 sm:px-12 lg:px-20">
          ...
          <p className="text-[11px] tracking-[0.3em] uppercase text-white/60 mb-2" style={{ fontFamily: "Inter, sans-serif" }}>Amenities</p>
      ...
      <section className="py-16 px-6 sm:px-12 lg:px-20 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          <p className="text-[10px] tracking-[0.3em] uppercase text-gray-400 mb-3" style={{ fontFamily: "Inter, sans-serif" }}>All Amenities</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {amenityGroups.map((group) => (
            <div key={group.title} className="border border-gray-100 p-6 hover:shadow-md transition-shadow">
              <h3
                className="text-[12px] tracking-[0.2em] uppercase text-black mb-4 pb-3 border-b border-gray-100"
              ...
              <ul className="space-y-3">
                {group.items.map((item) => (
                  <li key={item.name} className="flex items-start gap-2.5">
                    ...
                    <div>
                      <p className="text-sm text-black" style={{ fontFamily: "Inter, sans-serif", fontWeight: 500 }}>{item.name}</p>
                      <p className="text-[11px] text-gray-400" style={{ fontFamily: "Inter, sans-serif" }}>{item.sub}</p>
                    </div>
                  </li>
                ))}
              </ul>
      ...
      <section className="py-20 px-6 bg-black text-white text-center">
        <div className="max-w-2xl mx-auto">
          <p className="text-[10px] tracking-[0.3em] uppercase text-gray-500 mb-4" style={{ fontFamily: "Inter, sans-serif" }}>Experience all the amenities in person.</p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            ...
            <Link to="/outdoor-living" className="px-8 py-3 border border-gray-700 text-white text-[12px] tracking-[0.15em] uppercase hover:border-white transition-colors" style={{ fontFamily: "Inter, sans-serif" }}>
